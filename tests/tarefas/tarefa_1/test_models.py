...
class GroupModelTest(TestCase):
    ...
    @patch(
        "django.utils.timezone.now", return_value="2022-11-27T17:55:22.819371Z"
    )
...
class PetModelTest(TestCase):
    ...
    def test_field_sex_properties(self):
        ...
        for expected_choice in expected:
            message = f"Verifique se o campo 'sex' possui a choice '{expected_choice[0]}'"
        ...
        message = "Verifique se o campo 'sex' possui valor padrão e se o valor está correto."
...
class PetTraitRelationTest(TestCase):
    ...
    def test_if_trait_can_have_many_pets(self):
        ...
        self.assertEqual(
            len(self.traits), self.pets[0].traits.count(), message
        )
